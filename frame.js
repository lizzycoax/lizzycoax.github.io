            ...
            switch (game.gameStage) {
                case 0:
                    switch (newUnlockStage) {
                        case 1: document.getElementById("powerButton").hidden = false; break
                        case 2: document.getElementById("generationButton").hidden = false; break
                    }
                    break
                case 1:
                    switch (newUnlockStage) {
                        case 1: document.getElementById("stage1Buttons").hidden = false; break
                        case 2: document.getElementById("stage1Resets").hidden = false; break
                        case 3: document.getElementById("stage1Upgrades").hidden = false; break
                    }
                    break
            }
